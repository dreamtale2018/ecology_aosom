...
<table  border=1  bordercolor=black style="border-collapse:collapse;" width="100%" >
	<COLGROUP>
		...
		<COL width="5%">
		<COL width="5%">
		<%for(int i=0; i<qSize; i++) out.println("<COL width=\"5%\">");%>
		<COL width="5%">
		<COL width="5%">
		<COL width="6%">
		<COL width="6%">
	...
	<tbody>
		<tr>
			...
			<td colspan="<%=12+qSize%>" align="center"><%=SystemEnv.getHtmlLabelName(20080,user.getLanguage())%></td>
		</tr>
		<tr>
			...
			<td rowspan=2 align="center"><%=SystemEnv.getHtmlLabelName(20081,user.getLanguage())%>5-20分<%=SystemEnv.getHtmlLabelNames("81913,18929,81914",user.getLanguage())%></td>
			<td rowspan=2 align="center"><%=SystemEnv.getHtmlLabelName(20081,user.getLanguage())%>20分以上<%=SystemEnv.getHtmlLabelNames("81913,18929,81914",user.getLanguage())%></td>
	...
	%>
		<tr>
			...
			<td align="right"><%=strUtil.vString(scheduleMap.get("beLateCusA"))%></td>
			<td align="right"><%=strUtil.vString(scheduleMap.get("beLateCusB"))%></td>
			<td align="right"><%=strUtil.vString(scheduleMap.get("beLateCusC"))%></td>
