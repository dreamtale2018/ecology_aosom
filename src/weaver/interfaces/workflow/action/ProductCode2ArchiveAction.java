 ...
 *
 */
public class ProductCode2ArchiveAction implements Action {
	
	private static final Log logger = LogFactory.getLog(ProductCode2ArchiveAction.class);
		...
		try {
			...
			if (detailAList != null && detailAList.size() > 0) {
				for (int i = 0; i < detailAList.size(); i++) {
					...
					String ussl1DetailA = detailAMap.get("USSL1");		// US 第1批数量
					String casl1DetailA = detailAMap.get("CASL1");		// CA 第1批数量
					String uksl1DetailA = detailAMap.get("UKSL1");		// UK 第1批数量
					String desl1DetailA = detailAMap.get("DESL1");		// DE 第1批数量
					String frsl1DetailA = detailAMap.get("FRSL1");		// FR 第1批数量
					String itsl1DetailA = detailAMap.get("ITSL1");		// IT 第1批数量
					String essl1DetailA = detailAMap.get("ESSL1");		// ES 第1批数量
					String usjjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "USJJSX", detailAMap.get("USJJSX")));		
																		// US季节属性
					usjjsxDetailA = oracleManager.getChineseMsg(usjjsxDetailA);
					String usjrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "USJRSX", detailAMap.get("USJRSX")));	
																		// US节日属性
					usjrsxDetailA = oracleManager.getChineseMsg(usjrsxDetailA);
					String cajjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "CAJJSX", detailAMap.get("CAJJSX")));		
																		// CA季节属性
					cajjsxDetailA = oracleManager.getChineseMsg(cajjsxDetailA);
					String cajrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "CAJRSX", detailAMap.get("CAJRSX")));	
																		// CA节日属性
					cajrsxDetailA = oracleManager.getChineseMsg(cajrsxDetailA);
					String ukjjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "UKJJSX", detailAMap.get("UKJJSX")));		
																		// UK季节属性
					ukjjsxDetailA = oracleManager.getChineseMsg(ukjjsxDetailA);
					String ukjrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "UKJRSX", detailAMap.get("UKJRSX")));	
																		// UK节日属性
					ukjrsxDetailA = oracleManager.getChineseMsg(ukjrsxDetailA);
					String dejjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "DEJJSX", detailAMap.get("DEJJSX")));		
																		// DE季节属性
					dejjsxDetailA = oracleManager.getChineseMsg(dejjsxDetailA);
					String dejrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "DEJRSX", detailAMap.get("DEJRSX")));	
																		// DE节日属性
					dejrsxDetailA = oracleManager.getChineseMsg(dejrsxDetailA);
					String frjjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "FRJJSX", detailAMap.get("FRJJSX")));		
																		// FR季节属性
					frjjsxDetailA = oracleManager.getChineseMsg(frjjsxDetailA);
					String frjrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "FRJRSX", detailAMap.get("FRJRSX")));	
																		// FR节日属性
					frjrsxDetailA = oracleManager.getChineseMsg(frjrsxDetailA);
					String itjjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "ITJJSX", detailAMap.get("ITJJSX")));		
																		// IT季节属性
					itjjsxDetailA = oracleManager.getChineseMsg(itjjsxDetailA);
					String itjrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "ITJRSX", detailAMap.get("ITJRSX")));	
																		// IT节日属性
					itjrsxDetailA = oracleManager.getChineseMsg(itjrsxDetailA);
					String esjjsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "ESJJSX", detailAMap.get("ESJJSX")));		
																		// ES季节属性
					esjjsxDetailA = oracleManager.getChineseMsg(esjjsxDetailA);
					String esjrsxDetailA = Util.null2String(WorkflowUtils.getDetailFieldSelectName(workflowid, 1, "ESJRSX", detailAMap.get("ESJRSX")));	
																		// ES节日属性
