...
/**
 * 差旅费报销单结束节点新建费用支付台账<br>
 * 
 * @author ycj
 *
 */
public class UpdateFyzfClfbx implements Action
{
  private OracleManager oracleManager = new OracleManager();
  private Log logger = LogFactory.getLog(UpdateFyzfClfbx.class);
  ...
  public String execute(RequestInfo request)
  {
    ...
    try
    {
		...
		JE = Util.null2String(mainTable.get("JEBXBT"));										//金额
		...
		String zyDetailA = new StringBuilder().append(SQRXM).append("-")
							.append(FYXDL).append("-").append(" 收款单位：")
