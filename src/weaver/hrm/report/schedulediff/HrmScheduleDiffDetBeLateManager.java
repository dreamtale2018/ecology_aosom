	...
	protected List<Map<String, Object>> getScheduleList(List<Map<String, Object>> list, Map<String, Map<String, List<HrmSchedule>>> scheduleMap) {
		...
		if(list != null) {
			for(Map<String, Object> m : list) {
				...
				if (signDate.compareTo("2019-04-19") > 0 && signDate.compareTo("2019-05-31") <= 0 && signTime.compareTo("08:30:00") < 0) continue;
				if ((signDate.compareTo("2019-04-12") <= 0 || signDate.compareTo("2019-05-31") > 0) && signTime.compareTo("08:05:00") < 0) continue;
