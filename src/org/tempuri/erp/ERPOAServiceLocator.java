...
public class ERPOAServiceLocator extends org.apache.axis.client.Service implements org.tempuri.erp.ERPOAService {

    public ERPOAServiceLocator() {
    }


    public ERPOAServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public ERPOAServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for BasicHttpBinding_OAServiceContract
    private java.lang.String BasicHttpBinding_OAServiceContract_address = "http://210.83.64.179:1666/ERPOAService.svc";
    ...
    public org.tempuri.erp.OAServiceContract getBasicHttpBinding_OAServiceContract() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.erp.OAServiceContract getBasicHttpBinding_OAServiceContract(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.erp.BasicHttpBinding_OAServiceContractStub _stub = new org.tempuri.erp.BasicHttpBinding_OAServiceContractStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.erp.OAServiceContract.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.erp.BasicHttpBinding_OAServiceContractStub _stub = new org.tempuri.erp.BasicHttpBinding_OAServiceContractStub(new java.net.URL(BasicHttpBinding_OAServiceContract_address), this);
                _stub.setPortName(getBasicHttpBinding_OAServiceContractWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://tempuri.org/", "ERPOAService");
    }
