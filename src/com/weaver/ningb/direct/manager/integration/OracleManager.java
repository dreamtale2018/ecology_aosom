...
//						calendar.add(Calendar.DAY_OF_YEAR, -10);
	 ...
	 * @author ycj@20190115
	 */
	public OracleResult<String, String> pushProductApply(List<OracleProductOrder> list) {
		String task = "pushProductApply";
		String code = "0";
		String message = "成功";
		String request = null;
		String response = null;
	 ...
	 * @author ycj@20190228
	 */
	public OracleResult<String, String> pushProductCheck(List<OracleProductOrder> list) {
		String task = "pushProductCheck";
		String code = "0";
		String message = "成功";
		String request = null;
		String response = null;
	 ...
	 * @author ycj@20190614
	 */
	public OracleResult<String, String> updateStatus(List<OracleProductOrder> list,String method,String task) {
		String code = "0";
		String message = "成功";
		String request = null;
		String response = null;
		try {
			...
			String oaItemJson = createRequestJson2(list);
			response = proxy.updateStatus(oaItemJson, method, username, password);
			logger.info("response: " + response);
			if (!"S".equals(response)) {
				code = "-4";
				message = response;
